...
import com.bselzer.library.kotlin.extension.compose.ui.NumberPicker
import com.bselzer.library.kotlin.extension.compose.ui.ShowAppBarTitle
import com.bselzer.library.kotlin.extension.compose.ui.ValuePicker
...
class SettingsActivity : BaseActivity() {
    ...
    private fun ShowRefreshIntervalDialog(setShowDialog: (Boolean) -> Unit, setRefreshInterval: (Duration) -> Unit) {
        ...
        val min = max(1, wvwPref.refreshIntervalDefault.toInt(component.value))
