...
abstract class AppPreference(protected val datastore: DataStore<Preferences>) {
     ...
     */
    protected inline fun <reified T : Enum<T>> getEnum(key: Preferences.Key<String>, defaultValue: T): T = wrapper.getString(key.name, null)?.enumValueOrNull<T>() ?: defaultValue
