 ...
 */
@Composable
fun ShowCenteredRow(startValue: String, endValue: String, spacing: Dp = 5.dp, startTextStyle: TextStyle = LocalTextStyle.current, endTextStyle: TextStyle = LocalTextStyle.current) = ConstraintLayout(
    modifier = Modifier
        .fillMaxWidth()
        .wrapContentHeight()
) {
